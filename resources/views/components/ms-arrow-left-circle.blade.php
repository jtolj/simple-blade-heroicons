@props(['pushRef' => config('simple-blade-heroicons.use_references', false), 'showIcon' => true])
  ...
  @if ($pushRef)
    @if ($showIcon)
      <svg {{ $attributes->merge(['xmlns' => 'http://www.w3.org/2000/svg', 'viewBox' => '0 0 20 20', 'fill' => 'currentColor', 'aria-hidden' => 'true']) }}><use href="#heroicon-ms-arrow-left-circle" /></svg>
    @endif
  @once('heroicon-ms-arrow-left-circle')
    @push('simple-blade-icons')
      <g id="heroicon-ms-arrow-left-circle"><g clip-path="url(#clip0_9_2121)">
